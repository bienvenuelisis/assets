...
var sizes = ['small', 'sm', 'large', 'lg', 'xl', 'extra-large'];
...
function getSelect2ElValues(element2) {
    var actualValues = element2.find(':selected');
    var valuesTab = [];
...
var cookieBubblePosition = ['bottom-left', 'bottom-center', 'bottom-right', 'top-left', 'top-center', 'top-right'];
